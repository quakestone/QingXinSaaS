package com.qingxinsaas.gateway.config;
...
class SwaggerDocRegister extends Subscriber<InstancesChangeEvent>
{
    ...
    private final static String[] EXCLUDE_ROUTES = new String[] { "qingxinsaas-gateway", "qingxinsaas-auth", "qingxinsaas-file", "qingxinsaas-monitor" };
