...
​	氢信SaaS基座是在RuoYi开源项目的基础上进行升级开发，采用微服务架构和多租户设计，为企业客户提供高度可扩展的SaaS平台解决方案。核心功能涵盖RBAC权限管理、API网关、工作流引擎、数据隔离、支付集成及动态模块化配置等模块。为中大型企业提供灵活、可扩展的云服务解决方案，支持多租户管理、业务流程管理（BPM）、支付集成、区块链、商业智能（BI）和即时通讯（IM）等功能模块，毫无保留给个人及企业免费使用。
...
​	基于二十多年的 ERP 系统开发经验，我们发现传统的 ERP 系统中存在许多复杂问题，尤其是将 RuoYi 框架引入到已有系统中时，开发过程非常耗时且复杂，频繁地进行二次开发却难以满足需求。又经过4-5年的开发实践，我们组建了一个20多人的团队，在开发过程中也遇到了一些挑战：
...
- **SaaS多租户**  
  ...
  **总结：**在RBAC框架下，租户A定义和控制子租户B的权限边界，但租户B在此基础上具备对自己用户、部门和岗位的自主管理能力，并且所有权限控制严格限定在各自租户的数据范围内。
